...
class PlusMain_01 extends Component {
  /*
    ...
    props는 부모로부터 받은 변수를 자식이 변경할 수 없다.
  ...
  */
  ...
  /*
    두개의 버튼 Click Event Handler

    state에 선언된 변수 number의 값을 변경 시키고자 할 때는
    'this.setState() method 내부에서'
    변경하는 코드를 작성하면 됨

    plus button이 click되면 원래 number가 가지고 있는 값(this.state.number)에
    1을 plus하여 다시 number에 저장하라.
  */
  plus = () => {
    this.setState({
